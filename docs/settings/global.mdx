...
<ResponseField name="repo" type="Repo">
  Repo information to activate the "Edit this page" and "Raise an issue"
  buttons.
  <Expandable title="Repo">
    <ResponseField title="GitHub">
      ...
      <Expandable title="GitHub">
        ...
        <ResponseField name="contentDirectory" type="string">
          The path where the documentation content lives (the path to the
          `mint.json` file).
        </ResponseField>
